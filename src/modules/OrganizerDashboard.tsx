      ...
      <div className="max-w-5xl mx-auto px-4 mt-12">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="flex flex-col sm:flex-row items-center sm:items-start gap-8 mb-16 px-4">
          <div className="w-28 h-28 rounded-3xl bg-gradient-to-tr from-emerald-500 to-teal-600 p-1 shadow-2xl shadow-emerald-500/30 rotate-3">
            <div className="w-full h-full bg-zinc-900 rounded-[1.25rem] flex items-center justify-center text-4xl font-black text-white">RS</div>
          </div>
          <div className="text-center sm:text-left flex-1">
            <h1 className="text-4xl font-black text-zinc-900 dark:text-white mb-2 tracking-tight">Welcome back, Ramesh! 👋</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start px-2">
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.2 }} className="space-y-8 sticky top-24">
            ...
            <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-[2.5rem] p-8 shadow-2xl relative overflow-hidden">
               <div className="absolute top-0 right-0 w-48 h-48 bg-rose-500/10 rounded-full blur-[80px] pointer-events-none -mr-20 -mt-20"></div>
               ...
               <motion.button 
                ...
                className="w-full bg-zinc-950 dark:bg-white text-white dark:text-zinc-900 border-b-4 border-black dark:border-zinc-200 hover:bg-rose-500 dark:hover:bg-rose-500 hover:text-white hover:border-rose-700 transition-all font-black py-5 rounded-2xl flex justify-center items-center gap-3 uppercase tracking-widest text-sm shadow-xl"
               >
                 <Save size={20} /> Update Worldwide Score
               </motion.button>
